	...
	def mavenHome
        ...
        stage('Code Analysis') {
                ...
                withSonarQubeEnv('SonarQube') {
                        bat "${scannerHome}/bin/sonar-scanner -Dsonar.host.url=http://192.168.33.10:9000 -Dsonar.login=3a18156e6646e357deb267548584e75a83e8dace -Dsonar.projectVersion=1.0 -Dsonar.projectKey=PetClinic_Key -Dsonar.sources=src -Dsonar.java.binaries=."
                }
        } 
	stage('Build') {
